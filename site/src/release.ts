export const releaseUrl = 'https://github.com/sysone-help/sysone/releases/tag/v0.1.0';
export const packageUrl =
  'https://github.com/sysone-help/sysone/releases/download/v0.1.0/sysone-0.1.0.tgz';
