...
Before a pull request, run `npm run check` and `npm pack --dry-run -w sysone-help`. Update the library reference and changelog for public API changes. Keep credentials, submitted user data, generated tarballs and deployment files out of Git.
